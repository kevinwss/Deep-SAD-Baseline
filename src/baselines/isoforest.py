...
class IsoForest(object):
    ...
    def train(self, dataset: BaseADDataset, device: str = 'cpu', n_jobs_dataloader: int = 0):
        ...
        #train_loader = DataLoader(dataset=dataset, batch_size=128, shuffle=True,num_workers=n_jobs_dataloader, drop_last=False)

        _, train_loader = dataset.loaders(batch_size=128, num_workers=n_jobs_dataloader)
